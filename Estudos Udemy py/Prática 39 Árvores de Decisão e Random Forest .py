...
print(f"Acurácia da Árvore de Decisão: {sk.metrics.accuracy_score(y_test, predict)}")
...
print(f"Acurácia do Random Forest: {sk.metrics.accuracy_score(y_test, predict_rf)}")
